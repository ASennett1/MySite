    ...
    <main className="max-w-5xl mx-auto p-8 space-y-8">
      <section>
        ...
        <p className="mt-2 text-gray-600">
          Preview your weekly fantasy football matchup and rosters for the 2025 season using the Yahoo Fantasy Sports API.
        </p>
      </section>
            ...
            {matchupData.matchups.map((matchup) => (
              <div key={matchup.week} className="space-y-4">
                ...
                <h2 className="text-2xl font-semibold text-center">
                  {selectedWeek ? `Week ${matchup.week}` : `Week ${matchup.week} (${matchup.weekStart} - ${matchup.weekEnd})`}
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-medium mb-2">{matchup.yourTeam.name}</h3>
                    {hasProjections && (
                      <div className="mb-4">
                    ...
                    <h4 className="text-md font-medium mb-2">Roster</h4>
                  ...
                  {/* Opponent Team */}
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-medium mb-2">{matchup.opponent.name}</h3>
                    {hasProjections && (
                      <div className="mb-4">
